...
return PrayTime
-- local prayTime = PrayTime:new();
-- prayTime:setCalcMethod(prayTime.MWL);
-- userCoords = {"2.920162986", "101.652997388"}

-- local times = prayTime:getPrayerTimes(os.date("*t"), userCoords[1], userCoords[2]);
-- print('Fajr' , times[1]);
-- print('Sunrise' , times[2]);
-- print('Dhuhr' , times[3]);
-- print('Asr' , times[4]);
-- print('Sunset' , times[5]);
-- print('Maghrib' , times[6]);
-- print('Isha' , times[7]);